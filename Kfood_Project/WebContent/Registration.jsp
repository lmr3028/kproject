							...
							<table class="table admin-form theme-warning tc-checkbox-1 fs13">
								<thead>
									<tr class="bg-light">
										...
										<tr>
											<td><input type="text" name="product_no" class="gui-input"></td>
											<td><input type="text" name="name" class="gui-input"></td>
											<td><input type="text" name="pprice" class="gui-input"></td>
											<td><textarea cols="50" rows="10" name="pex"></textarea></td>
											<td><input type="file" name="pfile" class="gui-input"></td>
							</table>
							<div class="panel-footer clearfix p10 ph15">
							<button type="submit" class="btn btn-rounded btn-primary btn-block">상품 등록</button>
							</div>
						</div>
					</div>
				</div>
