			...
			<div class="tray tray-center" style="height: 1044px;">
				...
				<div class="panel mb25 mt5">
					<div class="panel-heading">
						<div class="col-md-10">
							<a onclick="location.href='ProductListPaging'" style="cursor:pointer"><h3>상품 게시판</h3></a>
						</div>
					...
					<div class="panel-menu p12 admin-form theme-primary">
						<div class="row">
							...
							<div class="col-md-2">
								<div>
									<button type="button" onclick="location.href='ProductListAsc'"
										class="btn active btn-default btn-block">낮은 가격 순</button>
								</div>
							</div>
							<div class="col-md-2">
								<div>
									<button type="button" onclick="location.href='ProductListDesc'"
										class="btn active btn-default btn-block">이름 순</button>
								</div>
							</div>
							<div class="col-md-2">
								<div>
									<button type="button" onclick="location.href='CartList?id=${sessionScope.id}'"
										...
										<tr>
												...
												<td>
													<div class="btn-group text-right">
														<button type="button"
															...
															onClick="location.href='ProductModify?product_no=${result.product_no}'">
															상품수정</button>
													</div>
												</td>
												<td>
													<div class="btn-group text-right">
														<button type="button"
															...
															onClick="location.href='ProductDelete?product_no=${result.product_no}'">
															상품삭제</button>
													</div>
												</td>
											</c:if>
											<td>
												<button type="button"
													...
													onClick="location.href='CartAdd?product_no=${result.product_no}'">장바구니 담기</button>
											</td>
										</tr>
