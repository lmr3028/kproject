										...
										<tr>
											...
											<td>
												<div class="btn-group text-right">
													<div class="col-md-6">
														<input type="text" name="qty" class="gui-input qty"
															value="${result.qty}" readonly>
													</div>
											...
											<c:choose>
													<c:when test="${result.approval==1}">
														<div class="btn-group text-right">
													<button type="button" class="btn btn-alert br2 btn-xs fs12">요청중</button>
												</div>
													...
													<button type="button" class="btn btn-alert br2 btn-xs fs12"
														onClick="location.href='Review?product_no=${result.product_no}&id=${result.id}'">리뷰 작성</button>
												</div>
